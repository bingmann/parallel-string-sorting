...
inline unsigned int
find_bkt_tree(const key_type& key, const key_type* splitter,
              const key_type* splitter_tree0, size_t numsplitters)
{
#if 1
...
//! Variant 3 of string sample-sort: use super-scalar binary search on
//! splitters, without index caching.
