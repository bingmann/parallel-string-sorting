...
#ifndef PSS_SRC_SEQUENTIAL_EBERLE_MERGESORT_LCP_LOSERTREE_HEADER
#define PSS_SRC_SEQUENTIAL_EBERLE_MERGESORT_LCP_LOSERTREE_HEADER
...
#endif // !PSS_SRC_SEQUENTIAL_EBERLE_MERGESORT_LCP_LOSERTREE_HEADER
