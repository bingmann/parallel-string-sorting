...
PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_C_burstsort,
                       "sinha/C_burstsort", "Original C-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_fbC_burstsort,
                       "sinha/fbC_burstsort", "Original fbC-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_sC_burstsort,
...
PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_CP_burstsort,
                       "sinha/CP_burstsort", "Original CP-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_fbCP_burstsort,
                       "sinha/fbCP_burstsort", "Original fbCP-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_sCP_burstsort,
...
PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_CPL_burstsort,
                       "sinha/CPL_burstsort", "Original CPL-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_fbCPL_burstsort,
                       "sinha/fbCPL_burstsort", "Original fbCPL-burstsort");

PSS_CONTESTANT_PREPARE(sinha_C_burstsort_prepare, sinha_sCPL_burstsort,
